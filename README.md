<img src="https://capsule-render.vercel.app/api?type=waving&height=300&color=gradient&customColorList=6&text=Pie%20Bot&textBg=false" />
...
|                                              | |
| **ㅋ [yacht, 요트] [yacht/요트] [pvp/대전] [유저]**   | 요트 다이스 대전을 신청합니다. 
| **ㅋ [yacht, 요트] [yacht/요트] [quit/퇴장] [유저]**  | 요트 다이스 게임을 종료합니다. |
| **ㅋ [yacht, 요트] [rank/순위] [페이지]**            | 유저들의 요트 다이스 게임 순위를 보여줍니다. |
| **ㅋ [yacht, 요트] [profile/프로필]**              | 요트 다이스 게임 프로필을 보여줍니다. |
| **ㅋ [yacht, 요트] [yacht/요트] [continue/이어하기]** | 요트 다이스 게임을 재개합니다. |
| **ㅋ [yacht, 설명서] [yacht/요트] [manual/설명서]**   | 요트 다이스 게임의 설명서를 보여줍니다. |
|                                              | |
| **ㅋ [gambling, 도박] [묵찌빠] [금액]**              | 묵찌빠 게임을 시작합니다.|
| **ㅋ [gambling, 도박] [슬롯머신] [금액]**             | 슬롯머신 게임을 시작합니다. |
| **ㅋ [gambling, 도박] [경마] [금액]**               | 경마 게임을 시작합니다. |
| **3. 화폐**                                    | |
