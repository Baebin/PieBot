...
public enum CommandParameter {
    ...
    YACHT_PVP(null, new String[] { "yacht", "요트" }, "[yacht/요트] [pvp/대전] [유저]", "요트 다이스 대전을 신청합니다.", CommandMode.EQUAL),
    YACHT_QUIT(null, new String[] { "yacht", "요트" }, "[yacht/요트] [quit/퇴장] [유저]", "요트 다이스 게임을 종료합니다.", CommandMode.EQUAL),
