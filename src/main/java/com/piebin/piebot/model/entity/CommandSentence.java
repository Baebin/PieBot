...
public enum CommandSentence {
    ...
    PAY_COMPLETED("송금", "{A}빙 송금이 완료되었습니다. (수수료 10%)", "전송에 착오가 없었는지 확인해주세요."),
    ...
    // Yacht
    YACHT_ARG1("요트 다이스", "[대전/퇴장/순위/프로필/이어하기/설명서]", "올바르지 않은 명령어입니다."),
    YACHT_PVP("요트 다이스", "대전을 신청한 유저가 첫 순서가 됩니다.", "수락하려면 이모지를 눌러주세요."),
    YACHT_PVP_ARG2("요트 다이스", "대상을 입력해주세요.", "서비스 이용자만 멘션이 가능합니다."),
    YACHT_PVP_SELF("요트 다이스", "대전 신청을 할 수 없는 대상입니다.", "자기 자신에게는 대전을 신청할 수 없습니다."),
    YACHT_PVP_EXISTS_FROM("요트 다이스", "이미 진행중인 게임이 있습니다.", "게임을 이어하거나 퇴장해주세요."),
    YACHT_PVP_EXISTS_TO("요트 다이스", "상대방이 이미 진행중인 게임이 있습니다.", "게임이 끝날 때까지 대기해주세요."),
    YACHT_QUIT("요트 다이스", "요트 다이스 게임에서 퇴장하였습니다.", "게임 결과가 무승부로 처리됩니다."),
    YACHT_QUIT_NONE("요트 다이스", "진행중인 게임이 존재하지 않습니다.", "유저에게 요트 다이스 개암을 신청해주세요."),
    YACHT_CONTINUE_NONE("요트 다이스 이어하기", "진행중인 게임이 존재하지 않습니다.", "유저에게 요트 다이스 게임을 신청해주세요."),
